...
const routerCustomer = require('./Customerlogin')
...
app.use('/Customerlogin',routerCustomer)
app.use('/Customerlogin',routeCategoryAndSearch)
app.use('/Customerlogin',routeCartAndOrders)
